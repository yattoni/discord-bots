...
Do not invent live prices, charts, or news — tell people to send a ticker by itself (like $AAPL, $BTC, or $^TNX), optionally with a range like $AAPL YTD, for a quote card. If they only mentioned you, greet them briefly in character and say they can ask a question or send a ticker.`
)
